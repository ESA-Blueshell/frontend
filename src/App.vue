...
<!--        <v-btn class="bar-button" text dark @click="goto('/events')">Events</v-btn>-->
    ...
    <v-footer dark color="brown darken-4">
      ...
      <v-spacer></v-spacer>
      <v-btn href="https://esa-blueshell.nl:28315" target="_blank" >
        take me back to the normal site
      </v-btn>
  ...
  mounted() {
    ...
    window.addEventListener('devtoolschange', event => {
      if (event.detail.isOpen) {
        ...
        document.getElementById('app').style.filter = 'invert(1)'
      }
    });
