  ...
  <v-app>
    ...
    <div class="mx-auto my-10" style="max-width: 800px">
      ...
      <v-expansion-panels accordion>
        <v-expansion-panel>
          ...
          <v-expansion-panel-content><p>The LegaCie, some call it the backbone of Blueshell, others
            ...
            <p>As said before this is one of the largest committees in Blueshell and we can always
              use more people! If you have a great idea for a gamenight like a theme or special
              game, or if you just want to help out a bit you should definitely join the
              committee!</p>
        ...
        <v-expansion-panel>
          ...
          <v-expansion-panel-content><p>You probably already read it from the name, but the SiteCie
            ...
            <p>Joining this committee does not require you to have any previous knowledge of
              ...
              enthusiasm to work with a team on something like this and make it great!</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
          <v-expansion-panel-header class="text-h5 font-weight-light">SmashCie
          </v-expansion-panel-header>
          <v-expansion-panel-content><p>Our Smash committee has come up relatively recently, but
            immediately grew to be one of the most active and important of Blueshell! As a party
            game that we all know from our childhood, to the newly released Smash Ultimate, we
            like to organize tournaments and game nights where you can play together with your
            fellow Blueshellers.</p>
            <p><b>Why join?</b></p>
            <p>This committee is of course for Smash enthusiasts, people who like the games and
              love to play it once in a while with friends. Also, in this committee people with
              Switches with the game are especially appreciated.</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
          <v-expansion-panel-header class="text-h5 font-weight-light">MediaCie
          </v-expansion-panel-header>
          <v-expansion-panel-content><p>This is the newest committee in Blueshell. This committee
            does
            everything related to the Blueshell Youtube and Twitch channel. They collect
            highlights which they can learn to edit and put on the Youtube channel. Of course,
            this is not the only thing the committee will do. They can also distribute some other
            fun moments on the Youtube channel and can help to stream on Twitch.</p>
            <p><b>Why join?</b></p>
            <p>This committee is for the aspiring streamers and video editors. But don’t worry,
              you don’t need any experience with software or streams. You will learn together
              along the way!</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
          <v-expansion-panel-header class="text-h5 font-weight-light">LoLCie
          </v-expansion-panel-header>
          <v-expansion-panel-content><p>Another one of the larger committees in Blueshell. This
            ...
            <p>It is a given that people with experience in LoL are greatly appreciated in this
              committee. Apart from that you don’t need any experience and will learn to organize
              big events along the way.</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
          ...
          <v-expansion-panel-content><p>This committee is responsible for all overwatch events in
            ...
            <p>This committee is meant for those that like Overwatch and would love to make others
              smile during their events. Other than that is this one of the smallest committees
              which makes teamwork far easier.</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
        ...
        <v-expansion-panel>
          <v-expansion-panel-header class="text-h5 font-weight-light">MCie
          </v-expansion-panel-header>
          <v-expansion-panel-content><p>
            Minecraft, that lovely game with a special place in all our
            hearts. While it may not be in the same E-sports genre as some of our other games,
            Blueshell has their very own Minecraft committee. They frequently organize events in
            the blocky game, ranging from PVP heavy arena tournaments to puzzle-like droppers to a
            permanent server where you can spend some quality relaxed time.</p>
            <p><b>Why join?</b></p>
            <p>Do you have good ideas for an online Minecraft event or would you like helping us
              organize these small events? Maybe you want to power to decide what we will organize
              on the official Blueshell survival server. This committee is guaranteed fun for all
              people.</p></v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
        ...
        <v-expansion-panel>
          ...
          <v-expansion-panel-content><p>As the name suggests this committee is focussed around Fun!
            ...
            <p>This committee will not only give you a lot of experience but are also some of the
              biggest activities around. In this committee, you are totally free to organize
              anything you want and you will get the tools to achieve greatness.</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
          ...
          <v-expansion-panel-content><p>This name might sound oddly familiar to those who don’t mind
            ...
            small events.</p>
            <p><b>Why join?</b></p>
            <p>This committee is for those passionate about the pokemon games who want to see is
              grow within Blueshell and find new friends (or rivals named Ass) to play and compete
              with. Not a lot of work but it is a lot of fun.</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
        <v-expansion-panel>
        ...
        <v-expansion-panel>
          ...
          <v-expansion-panel-content><p>Have you seen a flyer from Blueshell? Maybe a banner or some
            ...
            to the hard. This committee is essential to Blueshell as it is the primary way of
            making promotion to those yet unfamiliar with this amazing association.</p>
            <p><b>Why join?</b></p>
            <p>If you are even mildly interested in designing or just helping out, in general,
              this committee is perfect for you!</p>
          </v-expansion-panel-content>
        </v-expansion-panel>
      </v-expansion-panels>
    </div>
