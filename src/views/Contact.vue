    ...
    <div class="mx-3">
      <div class="mx-auto my-10" style="max-width: 800px">
        <p class="body-1">
          ...
          <a href="mailto:board@blueshell.utwente.nl" target="_blank" class="text-decoration-none">board@blueshell.utwente.nl</a>
          or join the
          <a href="https://discord.gg/WyDhbAP" target="_blank" class="text-decoration-none">Discord</a> and send a PM to
          the
          board members.
        </p>
        <p class="body-1">
